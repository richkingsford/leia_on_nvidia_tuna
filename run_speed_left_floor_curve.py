#!/usr/bin/env python3
"""Run a no-camera curve ramp with the left wheel as the only moving tread."""
            ...
            records.append(
                {
                    ...
                    "curve_experiment": {
                        ...
                        "operator_note": "Mirror of the right-only diagnostic: physical left tread should be the only moving tread.",
                    },
                    "vision": {
                        "found": False,
                        "dist_mm": None,
