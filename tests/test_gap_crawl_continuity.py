...
class TestGapCrawlContinuity(unittest.TestCase):
    ...
    def test_confidence_loss_stops_on_tenth_consecutive_frame(self):
        read_count = 0
        ...
        self.assertEqual(recovery_calls[0], 11)
    ...
    def test_holding_blind_lower_uses_additional_150ms(self):
        follow._set_game_profile("holding")

        self.assertEqual(follow._follow_step2_config().get("seat_mast_duration_ms"), 3625)
